...
# def insertProduct(number ,name ,surname, age,cinsiyet):
#     connection =mysql.connector.connect(host ="localhost",user ="root", password= "1234", database="scholl-db")
#     cursor = connection.cursor()


#     sql = "INSERT INTO Product(number ,name ,surname, age,cinsiyet) VALUES (%s,%s,%s,%s,%s)"
#     values = (number ,name ,surname, age,cinsiyet)
...
#     sql ="INSERT INTO Products(number ,name ,surname, age,cinsiyet) VALUES (%s,%s,%s,%s,%s) "
#     values= list
...
# while True:
#     name = input("isim :")
#     number = float(input("numara: "))
#     age= float(input("yaş: "))
#     cinsiyet= input("cinsiyet: ")
#     surname = input("soyadı: ")

#     list.append((number ,name ,surname, age,cinsiyet))
